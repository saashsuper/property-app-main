...
class BlockInspectionControllerTest extends TestCase
{
    ...
    public function test_index_displays_block_inspections()
    {
        ...
        $response = $this->actingAs($this->admin)->get(route('block-inspections.index'));
    ...
    public function test_index_filters_by_status()
    {
        ...
        $response = $this->actingAs($this->admin)->get(route('block-inspections.index', ['status' => 1]));
    ...
    {
        $response = $this->actingAs($this->admin)->get(route('block-inspections.create'));

        $response->assertStatus(200);
        $response->assertViewIs('block-inspections.create');
        $response->assertViewHas(['blocks', 'users']);
    }
    ...
    public function test_store_creates_new_inspection()
    {
        ...
        $response = $this->actingAs($this->admin)->post(route('block-inspections.store'), $data);
    ...
    {
        $response = $this->actingAs($this->admin)->post(route('block-inspections.store'), []);
    ...
    public function test_show_displays_inspection_details()
    {
        ...
        $response = $this->actingAs($this->admin)->get(route('block-inspections.show', $inspection));

        $response->assertStatus(200);
        $response->assertViewIs('block-inspections.show');
        $response->assertViewHas('blockInspection');
    }
    ...
    public function test_edit_displays_form()
    {
        ...
        $response = $this->actingAs($this->admin)->get(route('block-inspections.edit', $inspection));

        $response->assertStatus(200);
        $response->assertViewIs('block-inspections.edit');
        $response->assertViewHas(['blockInspection', 'blocks', 'users']);
    }
    ...
    public function test_update_modifies_inspection()
    {
        ...
        $response = $this->actingAs($this->admin)->put(route('block-inspections.update', $inspection), $data);
    ...
    public function test_destroy_deletes_inspection()
    {
        ...
        $response = $this->actingAs($this->admin)->delete(route('block-inspections.destroy', $inspection));
    ...
    public function test_start_updates_inspection_status()
    {
        ...
        $response = $this->actingAs($this->admin)->post(route('block-inspections.start', $inspection));
    ...
    public function test_complete_updates_inspection_status()
    {
        ...
        $response = $this->actingAs($this->admin)->post(route('block-inspections.complete', $inspection));
