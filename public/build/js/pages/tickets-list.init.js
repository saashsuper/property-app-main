...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function (element) {
        ...
        ticketsList.add({
            tickets_id: `<a href="apps-tickets-overview.html" class="fw-medium link-primary">#TBS2430190${element.id}</a>`,
            assign: imgHtml,
    ...
    ticketsList.remove("tickets_id", `<a href="apps-tickets-overview.html" class="fw-medium link-primary">#TBS243019001</a>`);
    tooltipElm();
    refreshCallbacks();
    ischeckboxcheck();
}
        ...
        Swal.fire({
            ...
            if (result.value) {
                for (i = 0; i < ids_array.length; i++) {
                    ticketsList.remove("tickets_id", `<a href="apps-tickets-overview.html" class="fw-medium link-primary">${ids_array[i]}</a>`);
                }
