    ...
    Array.from(json_records).forEach(function (element) {
        ...
        productList.add({
            ...
            products: '<div class="d-flex align-items-center">\
                ...
                <div>\
                    <h6 class="mb-0"><a href="apps-ecommerce-product-details.html" class="text-reset text-capitalize product-title">'+ element.product[0].title + '</a></h6>\
                </div>\
            </div>',
        ...
        if (
            ...
            productList.add({
                ...
                products: '<div class="d-flex align-items-center">\
                    ...
                    <div>\
                        <h6 class="mb-0"><a href="apps-ecommerce-product-details.html" class="text-reset product-title">'+ productTitleField.value + '</a></h6>\
                    </div>\
                </div>',
