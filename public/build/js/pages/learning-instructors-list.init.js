...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function (element) {
        instructorList.add({
            instructor_id: '<a href="apps-instructors-overview.html" class="fw-medium link-primary">#TBSI1590' + element.id + '</a>',
            instructor: '<div class="d-flex align-items-center gap-2">\
                ...
                <a href="apps-learning-overview.html" class="text-reset">'+ element.instructor[0].name + '</a>\
            </div>',
    ...
    instructorList.remove("instructor_id", `<a href="apps-instructors-overview.html" class="fw-medium link-primary">#TBSI159001</a>`);
    refreshCallbacks();
    ischeckboxcheck();
}
...
Array.prototype.slice.call(forms).forEach(function (form) {
    form.addEventListener('submit', function (event) {
        ...
        if (
            ...
            instructorList.add({
                instructor_id: '<a href="apps-instructors-overview.html" class="fw-medium link-primary">#TBSI1590' + count + '</a>',
                instructor: '<div class="d-flex align-items-center gap-2">\
                    <img src="'+ imageDom.src + '" alt="' + imageDom.getAttribute('alt') + '" class="avatar-xxs rounded-circle">\
                    <a href="apps-instructors-overview.html" class="text-reset">'+ instructorNameInput.value + '</a>\
                </div>',
        ...
        Swal.fire({
            ...
            if (result.value) {
                for (i = 0; i < ids_array.length; i++) {
                    instructorList.remove("instructor_id", `<a href="apps-instructors-overview.html" class="fw-medium link-primary">${ids_array[i]}</a>`);
                }
