...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function (element) {
        agencyList.add({
            agencies_id: '<a href="apps-real-estate-agencies-overview.html" class="fw-medium link-primary">#TBA0' + element.id + '</a>',
            since: element.since,
            agencies_Name: '<div class="d-flex align-items-center gap-2">\
                ...
                <a href="apps-real-estate-agencies-overview.html" class="text-reset text-capitalize">'+ element.agency[0].name + '</a>\
            </div>',
    ...
    agencyList.remove("agencies_id", `<a href="apps-real-estate-agencies-overview.html" class="fw-medium link-primary">#TBA001</a>`);
    refreshCallbacks();
    ischeckboxcheck();
}
...
Array.prototype.slice.call(forms).forEach(function (form) {
    form.addEventListener('submit', function (event) {
        ...
        if (
            ...
            agencyList.add({
                agencies_id: '<a href="apps-real-estate-agencies-overview.html" class="fw-medium link-primary">#TBA0' + count + '</a>',
                since: sinceInput.value,
                agencies_Name: '<div class="d-flex align-items-center gap-2">\
                    <img src="'+ imageDom.src + '" alt="' + imageDom.getAttribute('alt') + '" class="avatar-xxs rounded">\
                    <a href="apps-real-estate-agencies-overview.html" class="text-reset text-capitalize">'+ agencyNameInput.value + '</a>\
                </div>',
            ...
            Array.from(editValues).forEach(function (x) {
                ...
                if (selectedid == itemId) {
                    x.values({
                        agencies_id: '<a href="apps-real-estate-agencies-overview.html" class="fw-medium link-primary">' + idFieldInput.value + '</a>',
                        since: sinceInput.value,
                        agencies_Name: '<div class="d-flex align-items-center gap-2">\
                            <img src="'+ imageDom.src + '" alt="' + imageDom.getAttribute('alt') + '" class="avatar-xxs rounded">\
                            <a href="apps-real-estate-agencies-overview.html" class="text-reset text-capitalize">'+ agencyNameInput.value + '</a>\
        ...
        Swal.fire({
            ...
            if (result.value) {
                for (i = 0; i < ids_array.length; i++) {
                    agencyList.remove("agencies_id", `<a href="apps-real-estate-agencies-overview.html" class="fw-medium link-primary">${ids_array[i]}</a>`);
                }
