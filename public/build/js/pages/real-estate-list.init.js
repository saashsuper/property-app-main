...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function (element) {
        propertyList.add({
            id: '<a href="apps-real-estate-property-overview.html" class="fw-medium link-primary">#TBS' + element.id + '</a>',
            propert_Name: '<img src="' + element.property[0].img + '" alt="' + element.property[0].img_alt + '" class="rounded avatar-sm object-fit-cover d-none"><a href="apps-real-estate-property-overview.html" class="text-reset">' + element.property[0].title + '</a>',
    ...
    propertyList.remove("id", `<a href="apps-real-estate-property-overview.html" class="fw-medium link-primary">#TBS01</a>`);
    refreshCallbacks();
    ischeckboxcheck();
}
...
Array.prototype.slice.call(forms).forEach(function (form) {
    form.addEventListener('submit', function (event) {
        ...
        if (
            ...
            propertyList.add({
                id: '<a href="apps-real-estate-property-overview.html" class="fw-medium link-primary">#TBS' + count + '</a>',
                propert_Name: '<img src="' + imageDom.src + '" alt="' + imageDom.getAttribute('alt') + '" class="rounded avatar-sm object-fit-cover d-none"><a href="apps-real-estate-property-overview.html" class="text-reset">' + propertyTitleInput.value + '</a>',
        ...
        Swal.fire({
            ...
            if (result.value) {
                for (i = 0; i < ids_array.length; i++) {
                    propertyList.remove("id", `<a href="apps-real-estate-property-overview.html" class="fw-medium link-primary">${ids_array[i]}</a>`);
                }
