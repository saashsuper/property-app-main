...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function (element) {
        courseList.add({
            ...
            category: '<a href="apps-learning-grid.html" class="text-reset">' + element.category + '</a>',
            course_Name: '<div class="d-flex align-items-center gap-2">\
                ...
                <a href="apps-learning-overview.html" class="text-reset">'+ element.course[0].name + '</a>\
            </div>',
    ...
    form.addEventListener('submit', function (event) {
        ...
        if (
            ...
            courseList.add({
                ...
                category: '<a href="apps-learning-grid.html" class="text-reset">' + categoryInput.value + '</a>',
                course_Name: '<div class="d-flex align-items-center gap-2">\
                    <img src="'+ imageDom.src + '" alt="' + imageDom.getAttribute('alt') + '" class="avatar-xxs rounded">\
                    <a href="apps-learning-overview.html" class="text-reset">'+ courseTitleInput.value + '</a>\
                </div>',
