...
class IssueController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // ref_no will be auto-generated by the Issue model's boot method
     ...
     * by the Issue model's boot method using YYMM + ID format.
     * Kept for backward compatibility if needed.
     * 
     * @deprecated Use Issue model's boot method instead
     */
    private function generateIssueRefNo()
    {
        // This method is deprecated - ref_no generation is now handled
        // by the Issue model's boot method after record creation
