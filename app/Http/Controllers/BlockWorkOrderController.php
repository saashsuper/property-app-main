...
class BlockWorkOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // ref_no will be auto-generated by the BlockWorkOrder model's boot method
     ...
     * Note: This method is no longer used. ref_no is now auto-generated
     * by the BlockWorkOrder model's boot method using YYMM + ID format.
     * Kept for backward compatibility if needed.
     * 
     * @deprecated Use BlockWorkOrder model's boot method instead
     */
    private function generateWorkOrderRefNo()
    {
        // This method is deprecated - ref_no generation is now handled
        // by the BlockWorkOrder model's boot method after record creation
