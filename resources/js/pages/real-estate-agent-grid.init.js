        ...
        <div class="card ribbon-box ribbon-fill">\
            <div class="card-body">\
                    ...
                    <div class="flex-shrink-0">\
                        <div class="dropdown">\
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">\
                                <li><a class="dropdown-item" href="apps-real-estate-agent-overview.html"><i class="bi bi-eye align-baseline me-1"></i> Overview</a></li>\
                ...
                <div class="mt-3 text-center">\
                    ...
                    <h5 class="mt-4 mb-1"><a href="apps-real-estate-agent-overview.html" class="text-reset">'+ datas[i].agent[0].name + '</a></h5>\
