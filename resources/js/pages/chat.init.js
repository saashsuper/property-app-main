...
(function () {
    ...
    // favorite btn
    document.querySelectorAll(".favorite-btn").forEach(function (item) {
        ...
        if (err !== null) {
            ...
            users.forEach(function (userData, index) {
                var isUserProfile = userData.profile ? '<img src="' + userData.profile + '" class="rounded-circle img-fluid userprofile" alt=""><span class="user-status"></span>'
                    : '<div class="avatar-title rounded-circle bg-primary text-white fs-xxs">' + userData.nickname + '</div><span class="user-status"></span>';

                var isMessageCount = userData.messagecount ? '<div class="ms-auto"><span class="badge bg-dark-subtle text-dark rounded p-1">' +
            ...
            channelsData.forEach(function (isChannel, index) {
                var isMessage = isChannel.messagecount
                    ...
                    "</span></div>"
                    : "";
                var isMessageCount = isChannel.messagecount ? '<div class="ms-auto"><span class="badge bg-dark-subtle text-dark rounded p-1">' +
                    isChannel.messagecount +
                    "</span></div>"
                    : "";
        ...
        if (err !== null) {
            ...
            usersList.forEach(function (user, index) {
                var profile = user.profile
                    ...
                    : '<span class="avatar-title rounded-circle bg-primary fs-xxs">' + user.nickname + '</span>';
                  ...
                  <div class="flex-shrink-0">\
                      <div class="dropdown">\
                          ...
                          <div class="dropdown-menu dropdown-menu-end">\
                              <a class="dropdown-item" href="#"><i class="bi bi-pencil text-muted me-2 align-bottom"></i>Edit</a>\
                              <a class="dropdown-item" href="#"><i class="bi bi-slash-circle text-muted me-2 align-bottom"></i>Block</a>\
                              <a class="dropdown-item" href="#"><i class="bi bi-trash3 text-muted me-2 align-bottom"></i>Remove</a>\
                          </div>\
                      </div>\
                  </div>\
              </div>\
    ...
    function contactList() {
        document.querySelectorAll(".sort-contact ul li").forEach(function (item) {
            item.addEventListener("click", function (event) {
                ...
                document.querySelector("#users-chat .user-chat-topbar .text-truncate .username").innerHTML = contactName;
                ...
                if (item.querySelector(".align-items-center").querySelector(".avatar-xxs img")) {
                    ...
                    document.querySelector("#users-chat .user-own-img .avatar-xs").setAttribute("src", contactImg);
                    document.querySelector(".profile-offcanvas .profile-img").setAttribute("src", contactImg);
                } else {
                    document.querySelector("#users-chat .user-own-img .avatar-xs").setAttribute("src", dummyUserImage);
    ...
    function getMsg(id, msg, has_images, has_files, has_dropDown) {
                ...
                <ul class="list-inline mb-0">\
                    <li class="list-inline-item dropdown">\
                        ...
                        <div class="dropdown-menu">\
                            ...
                            <a class="dropdown-item" href="#"><i class="bi bi-bookmarks me-2 text-muted align-bottom"></i>Bookmark</a>\
                            <a class="dropdown-item delete-image" href="#"><i class="bi bi-trash3 me-2 text-muted align-bottom"></i>Delete</a>\
                        </div>\
                    </li>\
                </ul>\
                </div>\
        ...
        if (has_dropDown === true) {
            msgHTML +=
                ...
                <div class="dropdown-menu">\
                    <a class="dropdown-item reply-message" href="#"><i class="bi bi-reply me-2 text-muted"></i>Reply</a>\
                    <a class="dropdown-item" href="#"><i class="bi bi-share me-2 text-muted"></i>Forward</a>\
                    <a class="dropdown-item copy-message" href="#"><i class="bi bi-clipboard-check me-2 text-muted"></i>Copy</a>\
                    <a class="dropdown-item" href="#"><i class="bi bi-bookmarks me-2 text-muted"></i>Bookmark</a>\
                    <a class="dropdown-item delete-item" href="#"><i class="bi bi-trash3 me-2 text-muted"></i>Delete</a>\
                </div>\
            </div>'
        }
        msgHTML += '</div>';
    ...
    function chatSwap() {
        document.querySelectorAll("#userList li").forEach(function (item) {
            item.addEventListener("click", function () {
                ...
                document.querySelector("#users-chat .user-chat-topbar .text-truncate .username").innerHTML = username;
                ...
                if (document.getElementById(contactId).querySelector(".userprofile")) {
                    ...
                    document.querySelector("#users-chat .user-chat-topbar .avatar-xs").setAttribute("src", userProfile);
                    document.querySelector(".profile-offcanvas .avatar-lg").setAttribute("src", userProfile);
                } else {
                    document.querySelector("#users-chat .user-chat-topbar .avatar-xs").setAttribute("src", dummyUserImage);
            ...
            itemList.insertAdjacentHTML(
                ...
                chatItems + '\
                            ...
                            <div class="dropdown align-self-start message-box-drop">\
                                ...
                                <div class="dropdown-menu">\
                                    <a class="dropdown-item reply-message" href="#"><i class="bi bi-reply me-2 text-muted align-bottom"></i>Reply</a>\
                                    <a class="dropdown-item" href="#"><i class="bi bi-share me-2 text-muted align-bottom"></i>Forward</a>\
                                    <a class="dropdown-item copy-message" href="#""><i class="bi bi-clipboard-check me-2 text-muted align-bottom"></i>Copy</a>\
                                    <a class="dropdown-item" href="#"><i class="bi bi-bookmarks me-2 text-muted align-bottom"></i>Bookmark</a>\
    ...
    var getReplyChatList = function (chatReplyId, chatReplyItems) {
        ...
        newChatList.querySelectorAll(".copy-message").forEach(function (subitem) {
            subitem.addEventListener("click", function () {
                ...
                isText = subitem.closest(".ctext-wrap").querySelector(".ctext-content").innerText;
                navigator.clipboard.writeText(isText);
            });
        });
    };
...
function searchMessages() {
    ...
    searchLI = searchUL.querySelectorAll(".chat-list");
