    ...
    for (var i = (page - 1) * itemsPerPage; i < (page * itemsPerPage) && i < datas.length; i++) {
        ...
        <div class="card real-estate-grid-widgets card-animate">\
            ...
            <div class="card-body p-3">\
                ...
                <a href="apps-real-estate-property-overview.html">\
                ...
                <div class="border-top border-dashed mt-3 pt-3 d-flex align-items-center justify-content-between gap-3">\
                    ...
                    <a href="apps-real-estate-property-overview.html" class="link-effect">Read More <i class="bi bi-chevron-right align-baseline ms-1"></i></a>\
                </div>\
            </div>\
        </div>\
    </div>'
