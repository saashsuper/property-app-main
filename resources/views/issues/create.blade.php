        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Create Issue</h4>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('issues.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label for="title" class="form-label">{{ __('translation.problem-overview') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('location') is-invalid @enderror" 
                                               id="location" name="location" value="{{ old('location') }}" placeholder="e.g., Building A, Floor 3, Room 301">
                                        @error('location')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="ph-floppy-disk me-1"></i> Create Issue
                        </button>
                                    </div>
                                </div>
                            </div>
