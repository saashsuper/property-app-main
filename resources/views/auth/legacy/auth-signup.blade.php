                                    ...
                                    <div class="card-body py-5 d-flex justify-content-between flex-column h-100">
                                        ...
                                        <div class="text-center">
                                            <p class="text-white opacity-75 mb-0 mt-3">
                                                &copy;
                                                <script>document.write(new Date().getFullYear())</script> PROMAN. Crafted with <i class="mdi mdi-heart text-danger"></i> by PROMAN
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body p-sm-5 m-lg-4">
                                        ...
                                        <div class="p-2 mt-5">
                                            <form class="needs-validation" novalidate action="index">
                                                ...
                                                <div class="mb-4">
                                                    <p class="mb-0 fs-xs text-muted fst-italic">By registering you agree to the PROMAN <a href="pages-term-conditions" class="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</a></p>
                                                </div>
