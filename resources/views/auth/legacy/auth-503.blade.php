                                ...
                                <div class="card-body py-5 d-flex justify-content-between flex-column h-100">
                                    ...
                                    <div class="text-center">
                                        <p class="text-white opacity-75 mb-0 mt-3">
                                            ...
                                            </script> PROMAN. Crafted with <i class="mdi mdi-heart text-danger"></i> by PROMAN
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mb-0 border-0 shadow-none mb-0">
                                <div class="card-body p-sm-5 m-lg-4">
                                    <div class="error-img text-center px-5">
                                        <img src="{{ URL::asset('build/images/auth/503.png') }}" class="img-fluid" alt="">
                                    </div>
                                    <div class="mt-4 text-center pt-4">
                                        <div class="position-relative">
                                            <h4 class="fs-2xl error-subtitle text-uppercase mb-0">Service Unavailable</h4>
                                            <p class="fs-base text-muted mt-3">The service is temporarily unavailable, try again later!</p>
                                        </div>
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
