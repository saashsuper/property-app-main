                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div id="dropzone_{{ $asset->id }}" class="dropzone" style="min-height: 110px; border: 2px dashed #d1d5db; border-radius: 0.375rem; background-color: white;">
                                                        <div class="dz-message" data-dz-message>
                                                            <i class="ph-cloud-arrow-up text-primary mb-2" style="font-size: 1rem;"></i>
                                                            <div class="text-muted small" style="font-size: 0.75rem;">Drag & drop images or click to browse</div>
