        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Create Work Order</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Create New Work Order</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('property_id') is-invalid @enderror" 
                                               id="property_id" name="property_id" value="{{ old('property_id') }}" required>
                                        @error('property_id')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('contractor_id') is-invalid @enderror" 
                                               id="contractor_id" name="contractor_id" value="{{ old('contractor_id') }}" required>
                                        @error('contractor_id')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('priority_label') is-invalid @enderror" 
                                               id="priority_label" name="priority_label" value="{{ old('priority_label') }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('issue_category') is-invalid @enderror" 
                                               id="issue_category" name="issue_category" value="{{ old('issue_category') }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('pricing') is-invalid @enderror" 
                                               id="pricing" name="pricing" value="{{ old('pricing') }}" required>
                                        @error('pricing')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('preferred_day') is-invalid @enderror" 
                                               id="preferred_day" name="preferred_day" value="{{ old('preferred_day') }}">
                                        @error('preferred_day')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('time_from') is-invalid @enderror" 
                                               id="time_from" name="time_from" value="{{ old('time_from') }}">
                                        @error('time_from')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('time_to') is-invalid @enderror" 
                                               id="time_to" name="time_to" value="{{ old('time_to') }}">
                                        @error('time_to')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('report') is-invalid @enderror" 
                                               id="report" name="report" value="{{ old('report') }}">
                                        @error('report')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="ph-floppy-disk me-1"></i> Create Work Order
                        </button>
                            </div>
                        </form>
                    </div>
