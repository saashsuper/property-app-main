...
return [
    ...
    "product-grid" => "Griglia del prodotto",
    ...
    "sellers-overview"=> "Panoramica venditori",
    "filemanager" => "Gestore file",
    "cources" => "Corsi",
    "create-project" => "Crea progetto",
    "custom-ui" => "Interfaccia utente personalizzata",
    "term-condition" => "Termini e condizioni",
    "custom" => "Costume", 
    "list"=>"Elenco",
    "overview"=>"Panoramica",
    ...
    "invoice-overview" => "panoramica delle fatture",
    "details"=>"Particolari",
    ...
    "students" => "Studentesse",
    "subscriptions" => "le mie sottoscrizioni",
    "instructors" => "Istruttori",
    "create-instructor" => "Crea istruttore",
    "realestate" => "Immobiliare",
    "listing-grid" => "Griglia di elenco",
    "listing-list" => "Elenco degli elenchi",
    "listing-map" => "Mappa dell'elenco",
    "property-overview" =>"Panoramica della proprietà",
    "agent" => "Agente",
    "agencies" => "Agenzie",
    "agent-list" => "Elenco agenti",
    "agent-grid" => "Agente Griglia",
    "tickets-list-view" => "Biglietti",
    "tickets-overview" => "Panoramica dei biglietti",
    "add-property" => "Aggiungi proprietà",
    "earnings" => "Guadagni",
    "counter" => "Contatrice",
    "bootstrap" => "Bootstrap",
    "bootstrap-icons" => "Icone di bootstrap",
    "phosphor"=> "Fosforo",
    "phosphor-icons" => "Icone di fosforo",
    ...
    "Apex_Slope_Chart" => "Grafico a dispersione Apex",
