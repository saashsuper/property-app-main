...
return [
    ...
    "sellers-overview"=> "Обзор продавца",
    "list"=>"Список",
    "overview"=>"Обзор",
    "filemanager" => "Файловый менеджер",
    "cources" =>  "Курсы",
    "create-project"=>"Создать проект",
    "custom-ui" => "Пользовательский интерфейс",
    "custom" => "Обычай",
    "term-condition" => "Срок и условия",
    "tasks"=>"Tasks",
    ...
    "create-instructor" => "Создать инструктора",
    "mycourses" => "Мои курсы",
    "realestate" => "Недвижимость",
    "listing-grid" => "Листинговая сетка",
    "listing-list" => "Листинг Список",
    "listing-map" => "Листинг Карта",
    "property-overview" => "Обзор недвижимости",
    "agent" => "Агент",
    "agencies" => "Агентства",
    "agent-list" => "Список агентов",
    "agent-grid" => "Агент Сеть",
    "tickets-list-view" => "Билеты",
    "tickets-overview" => "Обзор билетов",
    "add-property" => "Добавить недвижимость",
    "earnings" => "Доход",
    "create-project"=>"Создать проект",
    "counter" => "Прилавок",
    "bootstrap" => "Начальная загрузка",
    "bootstrap-icons" => "Иконки начальной загрузки",
    "phosphor" => "фосфор",
    "phosphor-icons" => "Фосфорные иконы",
    "tasks"=>"Задания",
    ...
    "Apex_Slope_Chart" => "Диаграмма рассеяния апекса",
